...
const REVIEWS = [
  {
    text: 'Ordered at noon, received by 6PM in Beirut. Packaging was completely discreet — looked like any regular package. Quality is exceptional.',
    name: 'Sara M.',
    city: 'Beirut, Lebanon',
    initial: 'S',
    color: 'bg-purple-600',
  ...
  {
    text: 'Finally a Lebanese brand that takes this seriously. Quality is noticeably better than anything I\'ve tried ordering from abroad.',
    name: 'Lara K.',
  ...
  {
    text: 'WhatsApp support answered in minutes and guided me to the right product. Delivery to Tripoli in 2 days — plain box, no indication of what\'s inside.',
    name: 'Karim T.',
  ...
  {
    text: 'Discreet, fast, and the product was exactly as described. The cash-on-delivery option makes it so much easier. Will definitely order again.',
    name: 'Maya R.',
    city: 'Sidon, Lebanon',
    initial: 'M',
    color: 'bg-teal-600',
  ...
  {
    text: 'I was hesitant at first but the team was very professional on WhatsApp. Package arrived in Zahle next day. Absolutely recommended.',
    name: 'Rami A.',
    city: 'Zahle, Lebanon',
    initial: 'R',
    color: 'bg-indigo-600',
  ...
  {
    text: 'Best adult store in Lebanon — no question. Prices are fair, delivery is lightning fast, and the packaging is 100% discreet. 5 stars.',
    name: 'Nour H.',
    city: 'Beirut, Lebanon',
    initial: 'N',
    color: 'bg-sky-600',
