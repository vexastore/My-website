...
const REVIEWS = [
  {
    text: 'طلبت بالصبح وجالتني بنفس اليوم. الكرتونة عادية مو مكتوب عليها شي. المنتج تجاوز توقعاتي بكتير.',
    name: 'رانيا س.',
    city: 'بيروت، لبنان',
    initial: 'ر',
    color: 'bg-purple-600',
  ...
  {
    text: 'أخيراً متجر لبناني جدي. جودة المنتج ممتازة وأحسن بكتير من أشياء طلبتها من بره. خصوصيتك مضمونة 100%.',
    name: 'جورج م.',
    city: 'جونيه، لبنان',
    initial: 'ج',
    color: 'bg-rose-600',
  ...
  {
    text: 'تواصلت على واتساب وردوا بدقيقتين وساعدوني اختار المنتج المناسب. وصلني على طرابلس بيومين بكرتونة عادية.',
    name: 'طارق ح.',
    city: 'طرابلس، لبنان',
    initial: 'ط',
    color: 'bg-amber-600',
  ...
  {
    text: 'سريع، سري، والمنتج هيك متل ما وصفوه. خيار الدفع عند الاستلام سهّل الأمور كتير. رح طلب مرة تانية.',
    name: 'ديما ك.',
    city: 'صيدا، لبنان',
    initial: 'د',
    color: 'bg-teal-600',
  ...
  {
    text: 'كنت متردد بالأول بس الفريق على واتساب كان محترم ومهني. الطرد وصل الزهلة بيوم واحد والتغليف سري كلياً.',
    name: 'جاد ب.',
    city: 'زحلة، لبنان',
    initial: 'ج',
    color: 'bg-indigo-600',
  ...
  {
    text: 'أحسن متجر للكبار بلبنان بدون منافسة. أسعار معقولة، توصيل سريع، وتغليف سري بالكامل. 5 نجوم.',
    name: 'لينا ن.',
    city: 'بيروت، لبنان',
    initial: 'ل',
    color: 'bg-sky-600',
