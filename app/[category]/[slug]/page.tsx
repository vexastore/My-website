import { Metadata } from 'next';
  ...
  export default async function ProductPage({ params }: Props) {
    ...
    // Fetch ALL products server-side — client skips Firebase fetch entirely
    ...
    return (
      <>
        ...
        <ShopApp initialProducts={allProducts} initialCategory={categoryId} initialView="product" initialProductSlug={slug} />
      </>
    );
  }
