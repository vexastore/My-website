...
Version 1.5.2 restores production page rendering after the Meta Pixel integration passed a browser event handler through a React Server Component boundary. The pixel remains production-only and deferred until after hydration.
