...
async function readArticles(): Promise<BlogPost[]> {
  ...
  endpoint.searchParams.set('select', 'id,slug,title_en,title_ar,excerpt_en,excerpt_ar,content_en,content_ar,category_en,category_ar,read_time_seconds,image_path,source_image_url,published_at,updated_at');
