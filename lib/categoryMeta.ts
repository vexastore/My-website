...
export const CATEGORY_META: CategoryMeta[] = [
  ...
  { id: 'Dildos', slug: 'dildos', titleAr: 'ديلدو في لبنان | سيليكون آمن | متجر فيكسا', titleEn: 'Dildos Lebanon | Vexa Store', descAr: 'اشتر ديلدو في لبنان — سيليكون آمن وواقعي بأحجام وأشكال متعددة. توصيل سري في نفس اليوم في بيروت. دفع عند الاستلام. تغليف 100% خاص بدون شعار.', descEn: 'Shop dildos in Lebanon — body-safe silicone, realistic styles and different sizes. Discreet delivery in Beirut and across Lebanon. Cash on delivery.' },
