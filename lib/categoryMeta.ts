...
export const CATEGORY_META: CategoryMeta[] = [
  ...
  { id: 'Dildos', slug: 'dildos', titleAr: 'ديلدو في لبنان | سيليكون آمن | متجر فيكسا', titleEn: 'Dildo in Lebanon | Body-Safe Silicone | Vexa Toys', descAr: 'اشتر ديلدو في لبنان, سيليكون آمن وواقعي بأحجام وأشكال متعددة. توصيل سري في نفس اليوم في بيروت. دفع عند الاستلام. تغليف 100% خاص بدون شعار.', descEn: 'Buy a dildo in Lebanon, body-safe silicone & realistic styles in every size. Same-day discreet delivery in Beirut. Cash on delivery. 100% private packaging.' },
