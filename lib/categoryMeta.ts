...
export const CATEGORY_META: CategoryMeta[] = [
  ...
  { id: 'Vibrators', slug: 'vibrators', titleAr: 'هزازات فاخرة في لبنان | متجر فيكسا', titleEn: 'Vibrators Lebanon | Vexa Store', descAr: 'تسوّق 100+ هزاز في لبنان — نحيل، عصا، أرنب ونقطة G. سيليكون آمن للجسم. توصيل سري في نفس اليوم في بيروت. دفع عند الاستلام. خصوصيتك مضمونة.', descEn: 'Shop 100+ vibrators in Lebanon — bullet, wand, rabbit & G-spot styles. Body-safe silicone. Same-day discreet delivery in Beirut. Cash on delivery. Your privacy is guaranteed.' },
  ...
  { id: 'Dildos', slug: 'dildos', titleAr: 'ديلدو في لبنان | سيليكون آمن | متجر فيكسا', titleEn: 'Dildo in Lebanon | Body-Safe Silicone | Vexa Store', descAr: 'اشتر ديلدو في لبنان — سيليكون آمن وواقعي بأحجام وأشكال متعددة. توصيل سري في نفس اليوم في بيروت. دفع عند الاستلام. تغليف 100% خاص بدون شعار.', descEn: 'Buy a dildo in Lebanon — body-safe silicone & realistic styles in every size. Same-day discreet delivery in Beirut. Cash on delivery. 100% private plain packaging. No logo.' },
  { id: 'Lingerie', slug: 'lingerie', titleAr: 'لانجري فاخر في لبنان | متجر فيكسا', titleEn: 'Lingerie Lebanon | Vexa Store', descAr: 'لانجري فاخر في لبنان — دانتيل، ساتان، بدلات جسم وأطقم حميمية أنيقة للنساء. توصيل سري وسريع في بيروت. دفع عند الاستلام.', descEn: 'Luxury lingerie in Lebanon — lace bras, satin sets, bodysuits & intimate kits for women. Elegant & sexy styles. Discreet fast delivery in Beirut. Cash on delivery.' },
  { id: 'BDSM', slug: 'bdsm', titleAr: 'BDSM في لبنان | ألعاب للأزواج | متجر فيكسا', titleEn: 'BDSM in Lebanon | Restraints, Blindfolds & More | Vexa Store', descAr: 'تسوّق BDSM في لبنان للمبتدئين والمحترفين — قيود، عصابات عين، مجاديف، ريش، أطقم أزواج وأكثر. مواد آمنة. توصيل سري في بيروت. دفع عند الاستلام.', descEn: 'Shop BDSM in Lebanon — restraints, blindfolds, paddles, feathers, couples kits & more. Beginner to advanced. Body-safe materials. Discreet delivery in Beirut. Cash on delivery.' },
