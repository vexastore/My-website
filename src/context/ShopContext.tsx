...
export const ShopProvider: React.FC<{
  ...
  useEffect(() => {
    ...
    // v9 — cache key bumped to invalidate stale entries that were built without
    // the product_images gallery data. Previous versions of the server response
    // only carried products/{id}.image (which may be empty); this version
    // always includes the gallery image from product_images/{id}.
