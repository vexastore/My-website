...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ URL slug ÃÂ¢ÃÂÃÂ category mapping (for synchronous URL-based initialization) ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
export const ShopProvider: React.FC<{
  ...
  // Load products from Firebase Firestore on mount
    useEffect(() => {
      ...
      const CACHE_TTL = 24 * 60 * 60 * 1000; // 24 ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂ¹ÃÂÃÂ© ÃÂÃÂ¨ÃÂÃÂ¯ÃÂÃÂ 5 ÃÂÃÂ¯ÃÂÃÂÃÂÃÂ§ÃÂÃÂ¦ÃÂÃÂ
      ...
      const loadProducts = async () => {
        ...
        try {
          // ÃÂÃÂÃÂÃÂ¬ÃÂÃÂÃÂÃÂ¨ ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂªÃÂÃÂ¬ÃÂÃÂ§ÃÂÃÂª ÃÂÃÂÃÂÃÂ Vercel CDN (24 ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂ¹ÃÂÃÂ© cache) ÃÂ¢ÃÂÃÂ Firebase ÃÂÃÂÃÂÃÂ§ ÃÂÃÂªÃÂÃÂÃÂÃÂÃÂÃÂ±ÃÂÃÂ£ ÃÂÃÂÃÂÃÂÃÂÃÂ§ ÃÂÃÂ¥ÃÂÃÂ·ÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ§ÃÂÃÂ
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ ÃÂÃÂªÃÂÃÂ­ÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂµÃÂÃÂÃÂÃÂ± ÃÂÃÂÃÂÃÂ Firebase Client SDK (ÃÂÃÂÃÂÃÂÃÂÃÂ³ ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ© ÃÂÃÂµÃÂÃÂÃÂÃÂ­ÃÂÃÂ© ÃÂÃÂªÃÂÃÂÃÂÃÂ§ÃÂÃÂµÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂªÃÂÃÂ¬) ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  useEffect(() => {
    if (products.length === 0) return;

    // v4 ÃÂ¢ÃÂÃÂ cache key ÃÂÃÂ¬ÃÂÃÂ¯ÃÂÃÂÃÂÃÂ¯ÃÂÃÂ ÃÂÃÂÃÂÃÂªÃÂÃÂ¬ÃÂÃÂ§ÃÂÃÂÃÂÃÂ ÃÂÃÂ£ÃÂÃÂ cache ÃÂÃÂÃÂÃÂ¯ÃÂÃÂÃÂÃÂ
    ...
    // ÃÂÃÂªÃÂÃÂ­ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ cache ÃÂÃÂ£ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂ ÃÂ¢ÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂ· ÃÂÃÂ¥ÃÂÃÂ°ÃÂÃÂ§ ÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂ¨ÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ§ÃÂÃÂª ÃÂÃÂ­ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©
    try {
    ...
    // ÃÂÃÂ¥ÃÂÃÂ°ÃÂÃÂ§ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ³ÃÂÃÂÃÂÃÂ±ÃÂÃÂÃÂÃÂ± ÃÂÃÂ­ÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂµÃÂÃÂÃÂÃÂ± ÃÂÃÂÃÂÃÂ³ÃÂÃÂ¨ÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ ÃÂÃÂªÃÂÃÂ¬ÃÂÃÂ§ÃÂÃÂÃÂÃÂ² ÃÂÃÂ§ÃÂÃÂÃÂÃÂ·ÃÂÃÂÃÂÃÂ¨
    const alreadyLoaded = products.filter(p => p.image).length;
    if (alreadyLoaded >= products.length * 0.8) return;

    // request ÃÂÃÂÃÂÃÂ§ÃÂÃÂ­ÃÂÃÂ¯ÃÂÃÂ© ÃÂÃÂÃÂÃÂÃÂÃÂ³ÃÂÃÂÃÂÃÂ±ÃÂÃÂÃÂÃÂ± ÃÂ¢ÃÂÃÂ Vercel CDN ÃÂÃÂÃÂÃÂ­ÃÂÃÂÃÂÃÂ¸ ÃÂÃÂ§ÃÂÃÂÃÂÃÂµÃÂÃÂÃÂÃÂ± 24 ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂ¹ÃÂÃÂ© ÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ²ÃÂÃÂÃÂÃÂ§ÃÂÃÂ±
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Firestore product operations ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  ...
  const addToCart = (product: Product, quantity: number = 1, selectedVariants?: Record<string, string>) => {
    setCart(prevCart => {
      ...
      if (currentCartQty + quantity > product.stock) {
        alert(`ÃÂÃÂ¹ÃÂÃÂ°ÃÂÃÂ±ÃÂÃÂ§ÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ© ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ·ÃÂÃÂÃÂÃÂÃÂÃÂ¨ÃÂÃÂ© ÃÂÃÂºÃÂÃÂÃÂÃÂ± ÃÂÃÂÃÂÃÂªÃÂÃÂÃÂÃÂÃÂÃÂ±ÃÂÃÂ© ÃÂÃÂ­ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂ. ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ© ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂªÃÂÃÂ¨ÃÂÃÂÃÂÃÂÃÂÃÂ©: ${product.stock}`);
        return prevCart;
      }
      ...
      prevCart.map(item => {
        if (item.product.id === productId) {
          if (quantity > item.product.stock) {
            alert(`ÃÂÃÂ¹ÃÂÃÂ°ÃÂÃÂ±ÃÂÃÂ§ÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ© ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂªÃÂÃÂÃÂÃÂÃÂÃÂ±ÃÂÃÂ© ÃÂÃÂÃÂÃÂ ${item.product.stock} ÃÂÃÂÃÂÃÂÃÂÃÂ·.`);
            return item;
          }
  ...
  const deleteOrder = (orderId: string) => {
    if (window.confirm('ÃÂÃÂÃÂÃÂ ÃÂÃÂ£ÃÂÃÂÃÂÃÂª ÃÂÃÂÃÂÃÂªÃÂÃÂ£ÃÂÃÂÃÂÃÂ¯ ÃÂÃÂÃÂÃÂ ÃÂÃÂ±ÃÂÃÂºÃÂÃÂ¨ÃÂÃÂªÃÂÃÂ ÃÂÃÂÃÂÃÂ ÃÂÃÂ­ÃÂÃÂ°ÃÂÃÂ ÃÂÃÂÃÂÃÂ°ÃÂÃÂ§ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ·ÃÂÃÂÃÂÃÂ¨ ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂ¦ÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ')) {
